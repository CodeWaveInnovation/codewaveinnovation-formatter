...
describe("LineEndingRule", () => {
  ...
  describe("apply", () => {
    ...
    it("should convert to CR when specified", () => {
      ...
      const config: FormatterConfig = {
        rules: [
          { name: "line-ending", enabled: true, options: { style: "cr" } },
        ],
      };
    ...
    it("should default to LF when no options provided", () => {
      const content = "hello\r\nworld";
      const config: FormatterConfig = {
        rules: [{ name: "line-ending", enabled: true }],
      };
    ...
    it("should default to LF for unknown style", () => {
      const content = "hello\r\nworld";
      const config: FormatterConfig = {
        rules: [
          { name: "line-ending", enabled: true, options: { style: "unknown" } },
        ],
      };
