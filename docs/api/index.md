...
- **[Creating Custom Rules](#creating-rules)** - Extend with your own rules
- **[Plugin System](#plugins)** - Build and load plugins
...
For complete API documentation including all internal types and implementation details, see the [auto-generated TypeDoc reference](./README).
